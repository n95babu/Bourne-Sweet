  ...
  return (
    <div className="About_Pg">
      ...
      <div className="about_me_text">
        ...
        Favorites include the "Brooklyn Blackout Cake", hailed by Food & Wine as the "Best Chocolate Cake in America"; LCB's homage to our beloved Old Little Italy is the "Mott Street" cupcake, our take on tiramisu, a vanilla bean cupcake soaked in Illy espresso and topped with homemade mascarpone frosting; and the "Blue Velvet Cake", a moist buttermilk cake made with blueberries from farms in New Jersey, homemade cream cheese frosting and a dash of organic food coloring that is made from flowers.
        </p>
      </div>
    </div>
  );
